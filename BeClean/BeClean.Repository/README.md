...
- **`IEFBulkRepository<TModel>`** — extends `IRepository` with bulk operations: `MergeInsertAsync`, `MergeAsync`, `SynchronizeAsync`, `BulkInsertAsync`. Bulk operations bypass the change tracker: entities already tracked may be stale afterwards
